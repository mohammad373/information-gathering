def whois():
  try:
    ...
    baner()
    time.sleep(1)
    target =  input(Fore.RED+" ┌─["+Fore.GREEN+"H_NWWB"+Fore.BLUE+"~"+Fore.WHITE+"@HOME"+Fore.RED+"/"+Fore.CYAN+"IG"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"Whois"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"卐 ")
    ...
    if "http://" or "https://" not in target:
        target = "https://" + target
    url_me = "https://api.hackertarget.com/whois/?q="
